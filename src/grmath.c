...
vec4 Mat4x4MultVec4(mat4 m, vec4 v) {
...
void Mat4x4Rot(mat4 m, const F32 x, const F32 y, const F32 z) { // X - Y - Z order
	Mat4x4RotX(m,x);
	Mat4x4RotY(m,y);
	Mat4x4RotZ(m,z);
}
